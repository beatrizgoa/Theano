...
class Fully_Connected_Dropout(object):
    ...
    def __init__(self, rng, is_train, input, n_in, n_out, W=None, b=None, p=0.5, activation = None):
        self.input = input
        # end-snippet-1
...
class LeNetConvPoolLRNLayer(object):
    def __init__(self, rng, input, filter_shape, image_shape, poolsize=(2, 2), stride=(1, 1), lrn=False, activation = None):
            """
...
class LeNetConvPoolLayer(object):
    def __init__(self, rng, input, filter_shape, image_shape, poolsize=(1, 1),activation = None):
        """
        Allocate a LeNetConvPoolLayer with shared variable internal parameters.
