...
def evaluate_lenet5(learning_rate=0.01, n_epochs=400, nkerns=[96, 256, 386, 844, 256], batch_size=20):
    ...
    layer8_1 = LogisticRegression(input=layer7_1.output, n_in=2000, n_out=2)
    ...
    salidas_capa8_1 = theano.function(
        [index],
        layer8_1.y_pred,
        on_unused_input='ignore',
        givens={
    ...
    salidas_probabilidad_1 = theano.function(
        [index],
        layer8_1.p_y_given_x,
        on_unused_input='ignore',
    ...
    cost_1 = layer8_1.negative_log_likelihood(y)
    ...
    params_1 = layer0_1.params + layer1_1.params + layer2_1.params + layer3_1.params + layer4_1.params + layer5_1.params + layer6_1.params + layer7_1.params + layer8_1.params
    ...
    updates_1 = [
        (param_i, param_i - learning_rate * grad_i)
        for param_i, grad_i in zip(params_1, grads_1)]
    ...
    best_validation_loss_1 = numpy.inf
    best_iter_1 = 0
    error_epoch_1 = []
    lista_coste_1 = []
    epoch = 0
    ...
    while (epoch < n_epochs) and (not done_looping):
        ...
        for minibatch_index in range(n_train_batches):
            ...
            if (iter + 1) % validation_frequency == 0:
                ...
                # if we got the best validation score until now
                if this_validation_loss < best_validation_loss_1:
                    ...
                    # save best validation score and iteration number
                    best_validation_loss_1 = this_validation_loss
                    best_iter_1 = iter

                    w0_test_1 = layer0_1.W.get_value()
                    b0_test_1 = layer0_1.b.get_value()

                    w1_test_1 = layer1_1.W.get_value()
                    b1_test_1 = layer1_1.b.get_value()

                    w2_test_1 = layer2_1.W.get_value()
                    b2_test_1 = layer2_1.b.get_value()

                    w3_test_1 = layer3_1.W.get_value()
                    b3_test_1 = layer3_1.b.get_value()

                    w4_test_1 = layer4_1.W.get_value()
                    b4_test_1 = layer4_1.b.get_value()

                    w5_test_1 = layer5_1.W.get_value()
                    b5_test_1 = layer5_1.b.get_value()

                    w6_test_1 = layer6_1.W.get_value()
                    b6_test_1 = layer6_1.b.get_value()

                    w7_test_1 = layer7_1.W.get_value()
                    b7_test_1 = layer7_1.b.get_value()
                    w8_test_1 = layer8_1.W.get_value()
                    b8_test_1 = layer8_1.b.get_value()
    ...
    layer0_1.W.set_value(w0_test_1)
    layer0_1.b.set_value(b0_test_1)

    layer1_1.W.set_value(w1_test_1)
    layer1_1.b.set_value(b1_test_1)

    layer2_1.W.set_value(w2_test_1)
    layer2_1.b.set_value(b2_test_1)

    layer3_1.W.set_value(w3_test_1)
    layer3_1.b.set_value(b3_test_1)

    layer4_1.W.set_value(w4_test_1)
    layer4_1.b.set_value(b4_test_1)

    layer5_1.W.set_value(w5_test_1)
    layer5_1.b.set_value(b5_test_1)

    layer6_1.W.set_value(w6_test_1)
    layer6_1.b.set_value(b6_test_1)

    layer7_1.W.set_value(w7_test_1)
    layer7_1.b.set_value(b7_test_1)
    ...
    plt.ylabel('error')
    plt.xlabel('epoch')
    plt.savefig(out_path+'error_rgb.png')

    plt.clf()
    plt.plot(lista_coste)
    plt.ylabel('cost_ij')
    plt.xlabel('iteration')
    plt.savefig(out_path+'cost_rgb.png')

    plt.clf()
    plt.plot(error_epoch_1)
    plt.ylabel('error')
    plt.xlabel('epoch')
    plt.savefig(out_path+'error_nir.png')

    plt.clf()
    plt.plot(lista_coste_1)
    plt.ylabel('cost_ij')
    plt.xlabel('iteration')
