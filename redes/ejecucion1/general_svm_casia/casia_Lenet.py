...
def evaluate_lenet5(learning_rate=0.001, n_epochs=400, nkerns=[96, 256, 386, 384, 256], batch_size=20):
    ...
    train_set_x = train_set_x[12:32]
    test_set_x = train_set_x[12:32]
    y_train = y_train[12:32]
    y_test = y_train[12:32]
    valid_set_x= valid_set_x[12:32]
    y_val = y_val[12:32]
        ...
        for minibatch_index in range(n_train_batches):
            ...
            if (iter + 1) % validation_frequency == 0:
                ...
                print('epoch %i, minibatch %i/%i, validation error %f %%, cost %f' %
                      (epoch, minibatch_index + 1, n_train_batches, this_validation_loss * 100., cost_ij))
